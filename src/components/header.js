...
const Header = ({ siteTitle }) => {
  ...
  return (
    <>
      <header className="full-width bg-black py-4 px-0 sm:px-6 xl:px-0">
        <div className="px-20 mx-auto container flex items-center justify-between uppercase text-sm text-white relative">
          <div
